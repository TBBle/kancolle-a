...
// TODO: Align the field names with kca.net structures. Character, probably.
...
// Plan: Serde parser for wikiwiki tables.
...
// - For rowspan, duplicate previous row's data, assuming that's possible.
