...
pub(crate) mod args {
    ...
    fn source() -> impl Parser<BookShipCardPageSourceDiscriminants> {
        ...
        // I wish I could _append_ to the help message generated by derive-style,
        // and otherwise keep the parser generated by the derive.
        long("source")
            .help(help_msg)
    ...
    /// A tool to report on missing cards from your collection.
    ///
    ///
    /// For event sources, reports all ships with missing cards.
    /// For Normal source, reports only cards where you are missing the
    /// non-holo version.
    #[derive(Debug, Clone, Bpaf)]
    #[bpaf(options)]
    pub(crate) struct Options {
        /// A copy of your https://kancolle-arcade.net/ac/api/TcBook/info
        #[bpaf(argument("TCBOOK"))]
        pub(crate) tcbook: PathBuf,

        /// The event source to show cards for
        #[bpaf(external)]
        pub(crate) source: BookShipCardPageSourceDiscriminants,

        /// Should we exclude ships with 改 in their name?
        ...
        #[bpaf(fallback(false), display_fallback)]
