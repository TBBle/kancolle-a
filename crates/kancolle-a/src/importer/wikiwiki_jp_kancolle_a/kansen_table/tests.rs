...
// I think we're getting this from super? rustc complains it's unused.
...
fn parse_fixture_kansen_2024_09_02() {
    ...
    let 長門 = KansenShip {
        book_no: 1,
        rarity: 6,
        ship_name: "長門".to_string(),
        ship_class: "長門型".to_string(),
        ship_class_index: "1番艦".to_string(),
        ship_type: "戦艦".to_string(),
        endurance: 80,
        firepower: Some(82),
        armor: Some(75),
        torpedo: Some(0),
